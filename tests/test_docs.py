...
def test_the_workflow_builds_strictly_and_deploys_from_release_tags():
    """A pull request that breaks the docs has to fail before it can merge, and
    the site is only published when a release tag is pushed."""
